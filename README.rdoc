...
This is a Windows Phone 7.1 (Mango) focused fork of the Anders Gustafsson's port to Silverlight (https://github.com/cureos/mdcmmain) of the mdcm project (https://github.com/rcd/mdcm).
...
* introduction of the CFindSeriesClient, CFindSeriesQuery and CFindSeriesResponse classes as a series only C-FIND SCU operation
